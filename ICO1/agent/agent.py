...
class Agent:
    ...
    def make_fcnet(self):
        ...
        W_fc1 = my_ops.weight_variable([n_ffnet_inputs, 4], 0.001)
        b_fc1 = my_ops.bias_variable([4])

        W_fc2 = my_ops.weight_variable([4, 2], 0.001)
        b_fc2 = my_ops.bias_variable([2])

        W_fc3 = my_ops.weight_variable([2, 1], 0.001)
