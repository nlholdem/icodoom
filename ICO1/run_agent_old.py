...
def main():
    ...
    print ("conv_params", agent_args['conv_params'])
    print ("fc_img_params", agent_args['fc_img_params'])
    print ("fc_meas_params", agent_args['fc_meas_params'])
    print ("fc_joint_params", agent_args['fc_joint_params'])
    print ("target_dim", agent_args['target_dim'])
